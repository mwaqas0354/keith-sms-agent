  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="card p-5">
        <h3 className="font-semibold text-luxury-900 mb-4 flex items-center gap-2">
      ...
      <div className="card p-5">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {integrations.map((int) => (
            <div key={int.key} className="flex items-center gap-3 p-3 rounded-lg bg-luxury-50 border border-luxury-200">
              {int.configured ? (
                <CheckCircle className="w-5 h-5 text-emerald-400" />
              ) : (
                <XCircle className="w-5 h-5 text-luxury-400" />
              )}
              <div>
      ...
      <div className="card p-5 space-y-4">
        <h3 className="font-semibold text-luxury-900">OpenAI</h3>
        <div>
        ...
        <div>
          <label className="block text-sm text-luxury-500 mb-1">Model</label>
